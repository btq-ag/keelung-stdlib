...
type Word32 = (Field, Field, Field, Field)

-- SubFields: applies a substitution table (S-box) to each byte
subFields :: (Word32, Word32, Word32, Word32) -> (Word32, Word32, Word32, Word32)
subFields (w0, w1, w2, w3) = (sBoxWord32 w0, sBoxWord32 w1, sBoxWord32 w2, sBoxWord32 w3)
  where
    -- SBox on a word
    sBoxWord32 :: Word32 -> Word32
    sBoxWord32 (b0, b1, b2, b3) = (sBox b0, sBox b1, sBox b2, sBox b3)

    -- SBox on a single byte
    sBox :: Field -> Field
    sBox 0x00 = 0x63
    sBox 0x01 = 0x7c
    sBox 0x02 = 0x77
